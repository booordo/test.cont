...
__webpack_require__(/*! ./image-swap */ "./resources/js/image-swap.js");

__webpack_require__(/*! ./modal */ "./resources/js/modal.js");

__webpack_require__(/*! ./puzzle */ "./resources/js/puzzle.js");

__webpack_require__(/*! ./registration */ "./resources/js/registration.js");

__webpack_require__(/*! ./youtube */ "./resources/js/youtube.js");
...
(function () {
  window.addEventListener("load", function () {
    ...
    btnsOpen.forEach(function (el) {
      el.addEventListener("click", onOpenButtonClick);
    });
    btnsClose.forEach(function (el) {
      el.addEventListener("click", onCloseButtonClick);
    });
    btnsControl.forEach(function (el) {
      el.addEventListener("click", onControlButtonClick);
    });
...
(function () {
  ...
  function scale(el, k) {
    ...
    el.setAttribute("transform", "translate(".concat(x, " ").concat(y, ") scale(").concat(k, ") translate(-").concat(x, " -").concat(y, ")"));
  }
...
(function () {
  ...
  function onClick(e) {
    ...
    if (curOrganizationType == "individual") {
      document.getElementById("title_input_group").classList.add("auth-form__input-group_hidden"); // document.getElementById("name_input_group").classList.remove("auth-form__input-group_hidden");
      // document.getElementById("last_name_input_group").classList.remove("auth-form__input-group_hidden");
    } else {
      document.getElementById("title_input_group").classList.remove("auth-form__input-group_hidden"); // document.getElementById("name_input_group").classList.add("auth-form__input-group_hidden");
